...
class ESIM(nn.Module):
    ...
    def forward(self,
                ...
                premises_lengths,
                hypotheses,
                hypotheses_lengths,alternatives):
        """
        Args:
        ...
        # embedded_alternatives = self._word_embedding(alternatives)
        embedded_alternatives = alternatives
        ...
        output = logits.view(logits.size()[0],1,128)
        score = nn.functional.softmax(embedded_alternatives.bmm(output.transpose(2, 1)).squeeze(),dim=1)
